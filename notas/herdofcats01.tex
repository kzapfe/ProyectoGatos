...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WignerCirculoSoloGauss70X.png}
                \caption{The Gaussian Terms}
                \label{centrosgauss70}
  \end{subfigure}%
\begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WignerCirculoSoloInterferencias70X.png}
                \caption{The Interference Terms}
                \label{centrosinter70}
  \end{subfigure}
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WignerCirculo70X.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo70XhiSoloGauss01.png}
                \caption{The Gaussian Terms}
                \label{cuerdasgauss70}
  \end{subfigure}%
\begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo70XhiSoloInterferencias01.png}
                \caption{The Interference Terms}
                \label{cuerdasinter70}
  \end{subfigure}
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo70Xhi01.png}
                \caption{The Centre Function}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo7Xhi-ZerosReal-Bessel.png}
                \caption{$N=7$}
                \label{besselzero7}
  \end{subfigure}%
\begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo70Xhi-ZerosReal-Bessel.png}
                \caption{The Interference Terms}
                \label{$N=70$}
  \end{subfigure}
  \begin{subfigure}[b]{0.33\textwidth}
    \centering
          \includegraphics[width=0.99\textwidth]{WeylCirculo140Xhi-ZerosReal-Bessel.png}
                \caption{The Centre Function}
                \label{$N=140$}
  \end{subfigure}%
\caption{ The chord representation for the ``herd of cats'' over an harmonic
