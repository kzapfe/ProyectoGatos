...
#pragma omp section 
    {
      ...
      qx=false;
      qy=false;
      testeando="CorteCentrosGeneralQ.dat";
...
#pragma omp section
    {
	   ...
	   qx=false;
	   qy=true;
	   testeando="CorteCentrosGeneralX.dat";
...
#pragma omp section
    {
	   ...
	   qx=true;
	   qy=false;
	   testeando="CorteCentrosGeneralY.dat";
...
#pragma omp section
    {
	   ...
	   qx=true;
	   qy=true;
	   testeando="CorteCentrosGeneralP.dat";
...
#pragma omp section 
    {
      ...
      qx=false;
      qy=false;
      testeando="CorteCuerdasGeneralQ.dat";
...
#pragma omp section
    {
	   ...
	   qx=false;
	   qy=true;
	   testeando="CorteCuerdasGeneralMu.dat";
...
#pragma omp section
    {
	   ...
	   qx=true;
	   qy=false;
	   testeando="CorteCuerdasGeneralXhi.dat";
...
#pragma omp section
    {
	   ...
	   qx=true;
	   qy=true;
	   testeando="CorteCuerdasGeneralP.dat";
